...
//{
//    public class HttpClientAllegroDataDownloader : IAllegroDataDownloader
//    {
//        private readonly IBankSyncLogger logger;

//        public HttpClientAllegroDataDownloader(IBankSyncLogger logger)
//        {
//            this.logger = logger;
...
//                .ExecuteAsync(() =>
//                {
//                    Task<AllegroDataContainer> returnValue = this.LoadData(userConfig, oldestEntry);
//                    return returnValue;
//                });
...
//                else
//                {
//                    this.logger.Debug($"Logged in to Allegro for: {userConfig.Credentials.Id}");
//                }
...
//            LoginRequest payload = new LoginRequest(userConfig.Credentials.Id, userConfig.Credentials.Password.ToInsecureString());
...
//        private async Task<AllegroDataContainer> LoadData(ServiceUser userConfig, DateTime oldestEntryToDownload)
//        {
