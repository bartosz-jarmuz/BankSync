...
Numer referencyjny: 00000053305951531";
            ...
            Check.That(DescriptionDataExtractor.GetPayer(input)).IsEqualTo("+48 725 795 221");
        } 
...
Numer karty: 425125******2222";
            ...
            Check.That(DescriptionDataExtractor.GetPayer(input)).IsEqualTo("425125******2222");
        }
        
        [TestMethod]
        public void GetPayer_FromAccountName()
        {
            var input = @"Rachunek nadawcy: 22 1090 1506 0000 0001 0700 2222
Nazwa nadawcy: Pani JOHN DOE UL.RÓŻANA ZŁA WIEŚ WIELKA 18 87-134 CZARNOWO
Tytuł: Kasa";

            Check.That(DescriptionDataExtractor.GetPayer(input)).IsEqualTo("Pani JOHN DOE UL.RÓŻANA ZŁA WIEŚ WIELKA 18 87-134 CZARNOWO");


            input = @"Rachunek nadawcy: 22 1020 1475 0000 8802 0257 8888
Nazwa nadawcy: JIM N BEAM
Adres nadawcy: UL. 22 Accacia Avenue
Tytuł: WYCIAG
Referencje własne zleceniodawcy: 172173609222";

            Check.That(DescriptionDataExtractor.GetPayer(input)).IsEqualTo("JIM N BEAM");
